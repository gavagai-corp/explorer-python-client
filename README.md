...
*DashboardsApi* | [**get_grouped_comparison_graph_data**](docs/DashboardsApi.md#get_grouped_comparison_graph_data) | **GET** /projects/{id}/explore/dashboard/graphs/{graphId}/grouped_comparison | Get Grouped Comparison Graph
