...
class Model(object):
    ...
    def __init__(self, id=None, title=None, created=None, created_by=None, groups=None, users_access=None, ignore_terms=None, ignore_terms_dictionary=None, type=None, outdated=None, language=None, project=None, drivers=None, local_vars_configuration=None):  # noqa: E501
